...
R package **edgeTransport**, version **0.6.0**

[![CRAN status](https://www.r-pkg.org/badges/version/edgeTransport)](https://cran.r-project.org/package=edgeTransport)  [![R build status](https://github.com/rauner/edgeTransport/workflows/check/badge.svg)](https://github.com/rauner/edgeTransport/actions) [![codecov](https://codecov.io/gh/rauner/edgeTransport/branch/master/graph/badge.svg)](https://codecov.io/gh/rauner/edgeTransport) [![r-universe](https://pik-piam.r-universe.dev/badges/edgeTransport)](https://pik-piam.r-universe.dev/ui#builds)
...
Dirnaichner A, Rottoli M (2022). _edgeTransport: Prepare EDGE Transport Data for the REMIND model_. R package version 0.6.0.
